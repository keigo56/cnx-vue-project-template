<template>
  <div class="w-56">
    <Menu as="div" class="relative inline-block text-left">
      ...
      >
        <MenuItems
          class="z-10 absolute left-0 mt-2 w-56 origin-top-left divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"
        >
          <div class="px-1 py-1">
